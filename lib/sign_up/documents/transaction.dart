...
late List<Transaction> transactions=[];
  ...
  Future<void> loadJsonData() async {
    String jsonData = await DefaultAssetBundle.of(context).loadString('images/documentjson.json');
          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                ...transactions.map((transaction) => customTransactionDocument(
                  context,
                  transaction.address,
...
Widget customTransactionDocument(context, address, transactionID, line4, date, List<Document> documents) {
  return Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ListTile(
                      ...
                      onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context) => TransactionDocumentDetails(address: address, id: transactionID, documents: documents)));
                      },
                    )
                  ],
                ),
